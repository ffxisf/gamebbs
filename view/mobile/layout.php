...
<head>
	...
	<meta name="msapplication-TileImage" content="<?php echo QiniuPath; ?>/static/img/retinahd_icon.png" />
	<meta name="theme-color" content="#0088D1" />
	<link rel="icon" sizes="192x192" href="<?php echo QiniuPath; ?>/static/img/nice-highres.png" />
	<link rel="apple-touch-icon-precomposed" href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-57x57-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-72x72-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-114x114-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-144x144-precomposed.png" />
	<link rel="apple-touch-icon-precomposed" sizes="180x180" href="<?php echo QiniuPath; ?>/static/img/retinahd_icon.png" />
	<link rel="shortcut icon" type="image/ico" href="<?php echo $Config['WebsitePath']; ?>/favicon.ico" />
	<link rel="stylesheet" type="text/css" href="<?php echo QiniuPath; ?>/static/css/mobile/appframework.css?version=<?php echo CARBON_FORUM_VERSION; ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo QiniuPath; ?>/static/css/mobile/style.css?version=<?php echo CARBON_FORUM_VERSION; ?>" />
	...
	<script type="text/javascript" charset="utf-8" src="<?php echo QiniuPath; ?>/static/js/mobile/appframework.ui.min.js?version=<?php echo CARBON_FORUM_VERSION; ?>"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo QiniuPath; ?>/static/js/mobile/global.js?version=<?php echo CARBON_FORUM_VERSION; ?>"></script>
