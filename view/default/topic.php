...
<div class="main-content">
	...
	if ($Topic['IsLocked'] || (!$Topic['IsLocked'] && !$CurUserInfo)) {
		?>
		<script type="text/javascript">
			loadScript("<?php echo QiniuPath; ?>/static/js/default/topic.function.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
				loadScript("<?php echo QiniuPath; ?>/static/editor/ueditor.parse.min.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
					RenderTopic();
				});
			});
		</script>
		<script type="text/javascript" charset="utf-8"
				src="<?php echo QiniuPath; ?>/static/js/default/topic.function.js?version=<?php echo CARBON_FORUM_VERSION; ?>"></script>
		<div class="ad">
	...
	?>
		...
		<script type="text/javascript">
			...
			loadScript("<?php echo QiniuPath; ?>/static/js/default/topic.function.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
				InitNewTagsEditor();
				loadScript("<?php echo QiniuPath; ?>/static/editor/ueditor.config.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
					loadScript("<?php echo QiniuPath; ?>/static/editor/ueditor.all.min.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
