			...
			<p>
				...
				if ($CurUserRole >= 3) {
					...
					<script type="text/javascript">
						loadScript("<?php echo QiniuPath; ?>/static/js/jquery.async.uploader.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
							loadScript("<?php echo QiniuPath; ?>/static/js/default/tag.function.js?version=<?php echo CARBON_FORUM_VERSION; ?>", function () {
							});
						});
					</script>
