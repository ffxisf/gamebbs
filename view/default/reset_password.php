...
loadScript("<?php echo QiniuPath; ?>/static/js/default/account.function.js?version=<?php echo CARBON_FORUM_VERSION; ?>",function() {});
</script>
<!-- main-content start -->
				...
				<tbody>
					...
					<tr>
						...
						<td width="auto" align="left">
							<label><input type="text" name="VerifyCode" class="w100" onfocus="document.getElementById('Reset_Password_Verification_Code_Img').src='<?php echo $Config['WebsitePath']; ?>/seccode.php.php';document.getElementById('Reset_Password_Verification_Code_Img').style.display='inline';" value="" placeholder="<?php echo $Lang['Verification_Code']; ?>" /></label> 
