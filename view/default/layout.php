...
';
	...
	<link rel="apple-touch-icon-precomposed"
		  href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-57x57-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="72x72"
		  href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-72x72-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="114x114"
		  href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-114x114-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="144x144"
		  href="<?php echo QiniuPath; ?>/static/img/apple-touch-icon-144x144-precomposed.png"/>
	<link rel="apple-touch-icon-precomposed" sizes="180x180"
		  href="<?php echo QiniuPath; ?>/static/img/retinahd_icon.png"/>
	<link rel="shortcut icon" type="image/ico" href="<?php echo $Config['WebsitePath']; ?>/favicon.ico"/>
	<link
		href="<?php echo QiniuPath; ?>/static/css/default/style.css?version=<?php echo CARBON_FORUM_VERSION; ?>"
	...
	<script type="text/javascript" charset="utf-8"
			src="<?php echo QiniuPath; ?>/static/js/default/global.js?version=<?php echo CARBON_FORUM_VERSION; ?>"></script>
	<script type="text/javascript">
		<?php if ($CurUserID) {
...
<div class="wrapper">
			...
			<div class="inner-nav-panel">
				<div class="logo">
					<a href="<?php echo $Config['WebsitePath']; ?>/">
						<img src="<?php echo QiniuPath; ?>/static/img/logo.png"
	...
	<div class="copyright">
		<p>
			<?php echo $Config['SiteName']; ?> Powered By © 2006-2017 
